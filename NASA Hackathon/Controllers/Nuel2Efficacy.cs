...
{
    public class Nuel2Efficacy
    {
        public double Convert_GMT_to_Efficacy(double gmt)
        {
            // double person_eff=0;
        ...
        private double My_Log(double x, double a, double b, double c)
        {
            return a + b * Math.Log(x) + c * (Math.Log(x, 100));
        }

        private double My_Sigmoid(double x, double L, double x0, double k, double b)
        {
